...
@Component({
  selector: 'app-search-in-home-page',
  templateUrl: './search-in-home-page.component.html',
  styleUrls: ['./search-in-home-page.component.scss']
})
export class SearchInHomePageComponent implements OnInit {
  ...
  search() {
    ...
    this._router.navigate(['/showDoctors'],{queryParams:{specailtyid:this.specilatyId,cityId:this.cityId,areaId:this.areaId,name:this.doctorName}});
  }
